...
const SYSTEM_BACK = [
  ...
  "3. IGNORE tous les paragraphes descriptifs multilingues (suédois, danois, néerlandais, allemand, italien, etc.). Des mots comme `KASTANJEMELK`, `BALSAM`, `HOITOAINE`, `BESCHERMENDE` NE SONT PAS des ingrédients INCI.",
...
const SYSTEM_FRONT = [
  ...
  "3. `productName` : le nom de la gamme/produit (ex. `Effaclar Duo+`, `Foaming Cleanser`, `Niacinamide 10 % + Zinc 1 %`). Exclus la marque, les claims marketing, les volumes et les certifications.",
  "4. `productType` : le type de produit en français court (ex. `nettoyant visage`, `crème hydratante`, `sérum`, `shampoing`, `gel douche`, `démaquillant`, `huile capillaire`).",
