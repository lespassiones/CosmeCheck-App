 ...
 * support each one — Deno port of CosmetWiki/lib/coherence/claims.ts (verbatim
 * data; anti-hallucination knowledge base).
 */
...
export const CLAIM_CATEGORIES: ClaimCategory[] = [
  ...
  },
  {
    ...
    label: "Démêlage",
    productTypes: ["cheveux"],
    keywords: ["démêle", "démêlant", "demele", "demelant", "facile à coiffer", "detangling", "detangle"],
    actives: [
