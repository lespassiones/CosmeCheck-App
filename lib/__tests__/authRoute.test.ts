/**
 * resolveAuthRoute — décision de routage de l'AuthGuard (zone bug-prone).
 * Verrouille les scénarios qui ont causé des rebonds/boucles d'onboarding.
 */
...
describe('authentifié', () => {
  ...
  it('depuis (auth) après login, profil complet → home', () => {
    expect(
  ...
  it('onboarding explicitement terminé alors qu’on y est encore → home', () => {
    expect(
